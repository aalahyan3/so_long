...
/*   Updated: 2025/01/26 17:19:33 by aalahyan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct	s_sprite
{
	struct s_img	frame[2];
	int				current_frame;
};

struct	s_sprites
{
	struct s_sprite	player_l;
	struct s_sprite	player_r;
	struct s_sprite	p_run_l;
	struct s_sprite	p_run_r;
	struct s_sprite	enemy;
	struct s_sprite	exit;
};
